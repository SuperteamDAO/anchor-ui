...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b transition-colors hover:bg-neutral-100/80 data-[state=selected]:bg-neutral-100 dark:hover:bg-neutral-800/10 dark:data-[state=selected]:bg-neutral-800",
      className
    )}
    {...props}
  />
